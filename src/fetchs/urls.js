...
let getAddUserUrl = "/jasonWorkStat/user/addUser";// 添加用户
let getRemoveUserUrl = "/jasonWorkStat/user/removeUser";// 添加用户
...
let getAuthorityListUrl = "/jasonWorkStat/task/authorityList";// 获取权限列表
let getRanksListUrl = "/jasonWorkStat/task/ranksList";// 获取职位列表
